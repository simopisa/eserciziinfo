    ...
    <body id="principale" class="bg-purple">
        ...
        <div class="central-body">
            ...
            function sql_to_html_table($sqlresult, $delim = "\n")
            {
                ...
                $result = mysqli_query($connessione, "SELECT nome, cognome, sum(prezzo) as spesa_totale from proprietario, auto where proprietario.IDproprietario=auto.IDproprietario group by nome order by sum(prezzo) desc");
                # code...
