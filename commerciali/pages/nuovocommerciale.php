    ...
    <body>
        <nav class="menu" tabindex="0">
            ...
            <ul>
                ...
                <li tabindex="0" class="icon-new selected" onclick="window.location.href='#'"><span>Nuovo commerciale</span></li>
        ...
        <form action="../script/inseriscicom.php" method="post"    >
            <div class="user-login-box">
                <span class="user-name">Nuovo commerciale</span>
                <br><br>
