        ...
        <section>
            <nav id="app-nav" class="app-nav">
                <ul class="links-lvl1 app-nav-main-links links-with-text">
                    ...
                    <li><a href="newpvr.php" onclick="window.location.href='newpvr.php'" class="link-lvl1 selected"><i class="fa fa-plus"></i><span>Nuovo pvr</span></a></li>
                        ...
                        <div>
                            <div >
                                ...
                                <div class='panel-body'>
                                    <form class='form-horizontal' role='form' method="post" action="../script/inseriscipvr.php">
                                            ...
                                            <div class='col-md-8'>
                                                <div class='col-md-3'>
                                                    <div class='form-group internal input-group'>
                                                        <input class='form-control datepicker' id='id_checkin' name="user" >
                                                ...
                                                <div class='col-md-3'>
                                                    <div class='form-group internal input-group'>
                                                        <input class='form-control datepicker' id='id_checkout' name="ragsoc" required>
                                                        <span class='input-group-addon'>
