        ...
        <section>
            <nav id="app-nav" class="app-nav">
                <ul class="links-lvl1 app-nav-main-links links-with-text">
                    ...
                    <li><a href="newcomm.php" onclick="window.location.href='newcomm.php'" class="link-lvl1 selected"><i class="fa fa-plus"></i><span>Nuovo commerciale</span></a></li>
                        ...
                        <div>
                            <div >
                                ...
                                <div class='panel-body'>
                                    ...
                                    <form class='form-horizontal' role='form' method="post" action="../script/inseriscicom.php">
                                            ...
                                            <div class='col-md-8'>
                                                ...
                                                <div class='col-md-3 indent-small'>
                                                    <div class='form-group internal'>
                                                        <input class='form-control' id='id_first_name' placeholder='Nome' type='text' name="nome" required> 
                                                    </div>
                                                </div>
                                                <div class='col-md-3 indent-small'>
                                                    <div class='form-group internal'>
                                                        <input class='form-control' id='id_last_name' placeholder='Cognome' type='text' name="cognome" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='form-group'>
                                            ...
                                            <div class='col-md-8'>
                                                ...
                                                <div class='col-md-3 indent-small'>
                                                    <div class='form-group internal'>
                                                        <input class='form-control' id='id_first_name' placeholder='Indirizzo' type='text' name="indirizzo"> 
                                                    </div>
                                                </div>
                                                <div class='col-md-3 indent-small'>
                                                    <div class='form-group internal'>
                                                        <input class='form-control' id='id_last_name' placeholder='Città' type='text' name="citta" required>
                                                    </div>
                                                </div>
                                                <div class='col-md-3 indent-small'>
                                                    <div class='form-group internal'>
                                                        <input class='form-control' id='id_last_name' placeholder='Provincia' type='text' name="provincia" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class='form-group'>
                                            ...
                                            <div class='col-md-6'>
                                                <div class='form-group'>
                                                    <div class='col-md-11'>
                                                        <input class='form-control' id='id_email' placeholder='E-mail' type='email' name="mail">
                                                    </div>
                                                </div>
                                                <div class='form-group internal'>
                                                    <div class='col-md-11'>
                                                        <input class='form-control' id='id_phone' placeholder='Telefono: (xxx) - xxx xxxx' type='text' name="telefono">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class='col-md-8'>
                                                <div class='col-md-3'>
                                                    <div class='form-group internal input-group'>
                                                        <input class='form-control datepicker' id='id_checkin' name="user" required>
                                                ...
                                                <div class='col-md-3'>
                                                    <div class='form-group internal input-group'>
                                                        <input class='form-control datepicker' id='id_checkout' name="ragsoc">
                                                        <span class='input-group-addon'>
                                        ...
                                        <div class='form-group'>
                                            ...
                                            <div class='col-md-6'>
                                                <textarea class='form-control' id='id_comments' placeholder='Note aggiuntive' rows='3' name="note"></textarea>
                                            </div>
                                        </div>
                                        <div class='form-group'>
                                            <div class='col-md-offset-4 col-md-3'>
                                                <button class='btn-lg btn-primary' type='submit'>Inserisci</button>
                                            </div>
